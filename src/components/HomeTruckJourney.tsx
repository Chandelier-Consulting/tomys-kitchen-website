...
export default function HomeTruckJourney() {
  return (
    <>
      ...
      <section className="border-y border-border bg-background px-5 py-8 sm:px-6 lg:px-8">
      ...
      <section className="relative isolate overflow-hidden px-5 py-20 text-white sm:px-6 lg:px-8 lg:py-24">
        <div className="absolute inset-0 -z-20">
